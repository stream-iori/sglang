...
> 时间：~10 小时 (5 天 × 2h)
>
> **配套资源**: [Transformer 基本架构](../05-reference/transformer.md#transformer-basics-sglang) | [动手实验 - ZMQ 流水线 demo](../04-practice/exercises.md#practice-zmq-pipeline-demo) | [FAQ: event_loop 变体](../05-reference/faq.md#faq-event-loop-variants) | [调试技巧](../05-reference/debugging-guide.md)
